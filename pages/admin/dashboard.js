                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" data-dismiss="modal" onClick={() => this.addNewBlog()} >Yeni Blog Ekle</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="col-xl-3 col-sm-6 mb-3">
                                    <div className="card text-white bg-primary o-hidden h-100">
                                        <div className="card-body">
                                            ...
                                            <div className="mr-5">{this.state.blogs.length} Adet Blog Yazısı!</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-3 col-sm-6 mb-3">
                                            ...
                                            <tbody>
                                                {
                                                    this.state.blogs.map((item) =>
                                                        <tr>
                                                            ...
                                                            <td><button type="button" onClick={() => this.deleteBlog(item.id)} className="btn btn-danger">SİL</button></td>
                                                        </tr>
                                                    )
                                                }
                                            </tbody>
